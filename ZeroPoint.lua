...
["Egg Target overrides Animal, Rarity, and Mutation filters when selected. The Money / Second filter remains active so you can require a specific earning range even for a chosen pet type."] = "เมื่อเลือกเป้าหมายไข่ ระบบจะใช้นี้เป็นหลักแทนตัวกรองสัตว์ ความหายาก และมิวเทชัน ส่วนตัวกรองเงิน/วินาที จะยังคงทำงานเพื่อกำหนดช่วงรายได้ของสัตว์เลี้ยงที่ต้องการ",
